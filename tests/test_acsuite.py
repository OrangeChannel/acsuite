...
class ACsuiteTests(unittest.TestCase):
    ...
    def test_default_clip(self):
        ...
        self.assertEqual(acsuite._f2ts(self.BLANK_CLIP.fps, self.BLANK_CLIP.num_frames), '00:00:20.000000000')
    ...
    def test_f2ts(self):
        self.assertEqual(acsuite._f2ts(self.BLANK_CLIP.fps, 0), '00:00:00.000000000')
        self.assertEqual(acsuite._f2ts(self.BLANK_CLIP.fps, 69), '00:00:13.800000000')
